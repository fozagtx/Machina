...
describe("SeedstrClient", () => {
  ...
  beforeEach(() => {
    client = new SeedstrClient("test-api-key");
  ...
  describe("register", () => {
    it("should register a new agent", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        expect.stringContaining("/api/v2/register"),
  ...
  describe("verify", () => {
    it("should trigger verification", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        expect.stringContaining("/api/v2/verify"),
        expect.objectContaining({
          method: "POST",
        })
      );
  ...
  describe("listJobs", () => {
    it("should list available jobs", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        expect.stringContaining("/api/v2/jobs?limit=10&offset=5"),
        expect.anything()
      );
  ...
  describe("submitResponse", () => {
    it("should submit a job response", async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        expect.stringContaining("/api/v2/jobs/job_1/respond"),
        expect.objectContaining({
          method: "POST",
